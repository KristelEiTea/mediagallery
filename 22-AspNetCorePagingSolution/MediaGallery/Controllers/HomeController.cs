...
namespace MediaGallery.Controllers
{
    public class HomeController : Controller
    {
        ...
        public void GetFileWithEffect(int id, string effect, [FromServices]GetFileWithEffectsCommand getFileWithEffectsCommand)
        {
            var model = new PicWithEffectModel();
            model.Id = id;
            model.Effect = effect;
            model.outStream = Response.Body;
            ...
            Response.Clear();
            Response.Headers.Add("Content-Disposition", "attachment;filename=" + fileName);
            getFileWithEffectsCommand.Execute(model);
        }
